...
train_generator= trainGenerator(10,train_dir,'image','truth',train_gen_args,save_to_dir = None)
validation_generator = testGenerator(10,validation_dir,'image','truth',save_to_dir = None)
...
history = model.fit_generator(train_generator,steps_per_epoch = 32, epochs = 200, validation_data = validation_generator, validation_steps = 50)
model.save("first_fit.h5")
